            ...
            <div class="relative mt-1">
                <ListboxButton id="menu-button"
                    ...
                    <span class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2">
                        <ChevronUpDownIcon class="h-5 w-5 text-slate-500" aria-hidden="true" />
                    </span>
                </ListboxButton>
                ...
                <transition leave-active-class="transition duration-100 ease-in" leave-from-class="opacity-100"
                    ...
                    <ListboxOptions
                        ...
                        <ListboxOption v-slot="{ active, selected }" v-for="opt in options" :key="opt" :value="opt"
                            as="template">
                            <li :class="[
...
watch(selected, () => {
    productStore.filterProdsByCateg(selected.value)
})
